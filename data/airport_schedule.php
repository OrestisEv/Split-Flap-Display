...
$arrivals = array(
  ...
  "data" => array(
    ...
    12 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Atlanta","airline"=>randomAirline(),"gate"=>"C21","status"=>"1","remarks"=>"10m early"),
    13 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Baltimore","airline"=>randomAirline(),"gate"=>"A7","status"=>"0","remarks"=>""),
    14 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Charleston","airline"=>randomAirline(),"gate"=>"A18","status"=>"0","remarks"=>""),
    15 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Durban","airline"=>randomAirline(),"gate"=>"D44","status"=>"1","remarks"=>"delayed"),
    16 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Edinburgh","airline"=>randomAirline(),"gate"=>"A12","status"=>"0","remarks"=>""),
    17 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Frankfurt","airline"=>randomAirline(),"gate"=>"B2","status"=>"0","remarks"=>""),
    18 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Galveston","airline"=>randomAirline(),"gate"=>"B14","status"=>"0","remarks"=>""),
    19 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Havana","airline"=>randomAirline(),"gate"=>"C6","status"=>"0","remarks"=>""),
    20 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Indianapolis","airline"=>randomAirline(),"gate"=>"D16","status"=>"0","remarks"=>""),
    21 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Jakarta","airline"=>randomAirline(),"gate"=>"A6","status"=>"0","remarks"=>""),
    22 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Karachi","airline"=>randomAirline(),"gate"=>"C7","status"=>"0","remarks"=>""),
    23 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Los Angeles","airline"=>randomAirline(),"gate"=>"B12","status"=>"0","remarks"=>"")
  )
);
...
$departures = array(
  ...
  "data" => array(
    ...
    12 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Ouagadougou","airline"=>randomAirline(),"gate"=>"C21","status"=>"1","est 2130+"),
    13 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Prague","airline"=>randomAirline(),"gate"=>"A7","status"=>"0","remarks"=>""),
    14 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Quanduc","airline"=>randomAirline(),"gate"=>"A18","status"=>"0","remarks"=>""),
    15 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Rotterdam","airline"=>randomAirline(),"gate"=>"D44","status"=>"1","cancelled"),
    16 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Seoul","airline"=>randomAirline(),"gate"=>"A12","status"=>"0","remarks"=>""),
    17 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Tashkent","airline"=>randomAirline(),"gate"=>"B2","status"=>"0","remarks"=>""),
    18 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Ulaanbaatar","airline"=>randomAirline(),"gate"=>"B14","status"=>"1","remarks"=>"weather"),
    19 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Valparaiso","airline"=>randomAirline(),"gate"=>"C6","status"=>"0","remarks"=>""),
    20 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Wagga Wagga","airline"=>randomAirline(),"gate"=>"D16","status"=>"0","remarks"=>""),
    21 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Xuzhou","airline"=>randomAirline(),"gate"=>"A6","status"=>"0","remarks"=>""),
    22 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Yakutsk","airline"=>randomAirline(),"gate"=>"C7","status"=>"0","remarks"=>""),
    23 => array("flight"=>rand(1,2000),"scheduled"=>randomTime(),"city"=>"Zagreb","airline"=>randomAirline(),"gate"=>"B12","status"=>"0","remarks"=>"")
  )
);
